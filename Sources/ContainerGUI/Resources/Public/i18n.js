...
const ContainerGUII18n = (() => {
  ...
  const english = Object.freeze({
    ...
    "检查 Container 更新": "Check Container updates",
    "正在检查 Container 更新…": "Checking Container updates…",
    "Container 有新版本": "Container update available",
    "Container 已是最新版本": "Container is up to date",
    "Container 更新检查失败，可点击重试。": "Container update check failed. Click to retry.",
    "Apple Container 有新版本": "Apple Container update available",
    "仅提醒，不会自动安装或重启。升级前请查看兼容性说明并安排容器停机。": "Notification only; no automatic installation or restart. Review compatibility and schedule container downtime before upgrading.",
    "查看 Container 官方发布": "View official Container release",
