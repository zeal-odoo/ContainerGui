...
浏览和拉取镜像、创建容器，并执行经过精确确认和 CLI 状态回读的启动、停止与安全删除操作。
...
provides container and CPU/memory monitoring, logs, image browsing and pulling, container creation, and constrained
