...
final class ResourceMutationAssetTests: XCTestCase {
    ...
    func testRemoteRegistrySearchIsExplicitAndKeepsAllLocalImagesVisible() throws {
        ...
        XCTAssertTrue(html.contains("id=\"remoteRepositoryPagination\""))
        XCTAssertTrue(html.contains("id=\"previousRepositoriesButton\""))
        XCTAssertTrue(html.contains("id=\"nextRepositoriesButton\""))
        XCTAssertTrue(html.contains("id=\"remoteRepositoryPageNumbers\""))
        XCTAssertTrue(html.contains("id=\"remoteTagPagination\""))
        XCTAssertTrue(html.contains("id=\"previousTagsButton\""))
        XCTAssertTrue(html.contains("id=\"nextTagsButton\""))
        XCTAssertTrue(html.contains("id=\"remoteTagPageNumbers\""))
        XCTAssertTrue(html.contains("每页显示 10 条"))
        XCTAssertTrue(html.contains("src=\"/pagination.js\""))
        XCTAssertFalse(html.contains("id=\"loadMoreRepositoriesButton\""))
        XCTAssertFalse(html.contains("id=\"loadMoreTagsButton\""))
    ...
    func testRemotePaginationReplacesPagesAndExactTagOnlyFillsPullDialog() throws {
        ...
        XCTAssertFalse(script.contains("appendUniqueBy"))
        XCTAssertFalse(script.contains("loadMoreRemoteRepositories"))
        XCTAssertFalse(script.contains("loadMoreRemoteTags"))
        XCTAssertTrue(script.contains("showPreviousRemoteRepositories"))
        XCTAssertTrue(script.contains("showNextRemoteRepositories"))
        XCTAssertTrue(script.contains("showPreviousRemoteTags"))
        XCTAssertTrue(script.contains("showNextRemoteTags"))
        XCTAssertTrue(script.contains("state.remoteRepositories = result.items || []"))
        XCTAssertTrue(script.contains("state.remoteTags = result.items || []"))
        XCTAssertTrue(script.contains("remoteRepositoryPageSize: 10"))
        XCTAssertTrue(script.contains("remoteTagPageSize: 10"))
        XCTAssertTrue(script.contains("renderPaginationPageNumbers"))
