...
final class ResourceMutationAssetTests: XCTestCase {
    ...
    func testRemoteRegistrySearchIsExplicitAndKeepsAllLocalImagesVisible() throws {
        ...
        XCTAssertTrue(html.contains("id=\"remoteRepositoryPageLabel\""))
        ...
        XCTAssertTrue(html.contains("id=\"remoteTagPageLabel\""))
        XCTAssertTrue(html.contains("每页显示 20 条"))
    ...
    func testRemotePaginationReplacesPagesAndExactTagOnlyFillsPullDialog() throws {
        ...
        XCTAssertTrue(script.contains("remoteRepositoryPageSize: 20"))
        XCTAssertTrue(script.contains("remoteTagPageSize: 20"))
